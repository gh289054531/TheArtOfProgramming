...
public class Solution2 {
	 ...
	 * @param right
	 */
	public static <T extends Comparable<? super T>> T QuickSelect(T[] input, int left, int right, int k) {
	...
	public static void main(String[] args) {
		Integer[] test1 = new Integer[] { 3, 7, 8, 21, 23, 23, 32, 34, 36, 46, 54, 58, 87, 123, 213, 213, 234, 324, 432, 432, 543, 543, 543, 653, 876, 987, 4865, 5324, 7645, 8768, 56765 };
		for (int i = 0; i < test1.length; i++) {
			System.out.println(Solution2.QuickSelect(test1, 0, test1.length - 1, i + 1));
			Arrays.sort(test1);
		}
	}
}
